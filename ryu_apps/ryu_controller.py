...
from ryu.lib.packet import packet  # type: ignore
from ryu.lib.packet import ethernet  # type: ignore
from ryu.lib.packet import ether_types  # type: ignore
...
class SimpleSwitch(app_manager.RyuApp):
    ...
    def _packet_in_handler(self, ev):
        ...
        # Avoid installing flows for unknown destination
